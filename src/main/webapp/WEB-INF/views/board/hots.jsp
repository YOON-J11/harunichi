							...
							<c:if test="${not empty top100.boardImg1}">
								<div class="img-thumb">
									<c:if test="${not empty top100.boardImg1}">
										<div class="img-thumb">
											<c:choose>
												<c:when test="${fn:startsWith(top100.boardImg1, 'http')}">
													<img src="${top100.boardImg1}" alt="게시글 이미지" loading="lazy">
												</c:when>
												<c:otherwise>
													<img src="${contextPath}/resources/images/board/${top100.boardImg1}" 
